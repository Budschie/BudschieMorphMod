...
//				
//				if(vertexFormat.hasColor() && vertexFormat.hasNormal() && vertexFormat.hasPosition() && vertexFormat.hasUV(0))
//				{
...
//						if(rs.isPresent())
//						{
//							RenderType type = RenderType.getEntityTranslucent(rs.get());
//							builder = buffer.getBuffer(type);
//						}
//						else
//						{
...
//								float normalZ)
//						{
//							builder.addVertex(x, y, z, 255, 255, 255, 255, texU, texV, overlayUV, lightmapUV, normalX, normalY,
//									normalZ);
//						}
//						
//						@Override
