...
public class DataModifierRegistry
{
	...
	public static Supplier<IForgeRegistry<DataModifierHolder<? extends DataModifier>>> REGISTRY = DATA_MODIFIER_REGISTRY.makeRegistry(() -> new RegistryBuilder<DataModifierHolder<?>>().disableSaving().setName(DATA_MODIFIER_REGISTRY_ID));
